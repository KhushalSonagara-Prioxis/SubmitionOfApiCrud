...
namespace Evaluation.Models.SpDbContext;

    public partial class MovieReviewSpContext : DbContext
    {
        public MovieReviewSpContext() { }
        public MovieReviewSpContext(DbContextOptions<MovieReviewSpContext> options)
            : base(options)
        {
        }
